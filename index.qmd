...
![Map of child mortality in 2019](images/death%202019_1.jpg){#fig-map}
...
Child mortality is highly related to nation-level development (as assessed by SDI) and access to quality health care (as evaluated by HAQ). This relationship is shown in @fig-sdi and @fig-haq
...
Bolivia is considered a lower middle-income country. As shown in @fig-anova and @tbl-wilcox, lower middle-income countries tend to have higher mortality than upper middle-income countries and high-income countries. We can also observe that the higher the country's income, the lower the child mortality rate.
